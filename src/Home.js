...
import conf from "../src/assets/wallpaper.jpg";
            ...
            <div className="relative h-screen ">
                ...
                <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
                    ...
                    <div className=" flex flex-col items-center justify-center pb-8">
                        ...
                        <p className="text-[26px] text-white -mt-2">ATBシ</p>
                    </div>
                    ...
                    >
                        ...
                        <button
                          type="submit"
                          className=" bg-blue-500 hover:big-blue-400 duration-100 ease-out font-bold w-[5rem] md:w-[7rem] rounded-full py-[5px] md:py-[7px] mt-2 md:mt-4 "
                        >
                          Next
                        </button>
                    </form>
