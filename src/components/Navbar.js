    ...
    <div className="bg-black/90">
      <div className=" h-[5rem] flex items-center justify-between px-4 md:max-w-[90vw] mx-auto">
        ...
        <div className="">
          ...
          <li><a href="https://github.com/aaryavbehl">GitHub</a></li>
          <li><a href="https://linkedin.com/in/aaryavbehl">Linkedin</a></li>
          <li><a href="https://aaryav.netlify.app">Portfolio Website</a></li>
          </ul>
        </div>
      </div>
    </div>
